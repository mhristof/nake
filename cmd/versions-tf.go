...
var versionsTFCmd = &cobra.Command{
	Use:   "versions.tf",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = ioutil.WriteFile(output, []byte(terraform.Versions(source, strict)), 0o644)
		if err != nil {
			panic(err)
		}
	},
...
func init() {
	...
	versionsTFCmd.PersistentFlags().StringP("source", "s", tfDataDir, "The .terraform directory to scan for versions")
